  ...
  return (
    <section className="desktop:grid desktop:grid-cols-3 mobile:flex mobile:flex-col gap-4">
      <div className="group relative overflow-hidden bg-cover bg-no-repeat rounded-2xl">
        <Image
          src={ImgBoraCodar}
          alt="Imagem do projeto desafios bora codar"
        ...
        <div className="flex flex-col gap-3 items-start justify-end w-full h-full rounded-2xl py-4 px-4 bg-gradient-to-t from-blackpearl-950 to-transparent absolute -bottom-[100%] transition-all duration-500 invisible group-hover:visible group-hover:bottom-0">
          ...
          <h1 className="text-zinc-100 font-bold text-3xl tracking-tighter mt-3">
            Desafios Bora Codar
          </h1>
          <p className="text-left font-normal text-zinc-200 text-[0.875rem]">
            Uma coleção de desafios promovidos pela rocketseat. Todas as
            interfaces foram desenvolvidas em HTML, CSS e JS, de maneira
            responsiva e com interfaces incríveis! Estes projetos contribuiu
            muito para abranger meus conhecimentos em Front-end.
          </p>
          <Button
            name="Ver Projeto"
      ...
      <div className="group relative overflow-hidden bg-cover bg-no-repeat rounded-2xl">
        ...
        <div className="flex flex-col gap-3 items-start justify-end w-full h-full rounded-2xl py-4 px-4 bg-gradient-to-t from-blackpearl-950 to-transparent absolute -bottom-[100%] transition-all duration-500 invisible group-hover:visible group-hover:bottom-0">
          ...
          <p className="text-left font-normal text-zinc-200 text-[0.875rem]">
            Uma aplicação web e mobile desenvolvida com React JS, TypeScript,
            ViteJS, Fastify, Node, Prisma Radix UI e React Native no mobile.
            Esta aplicação foi desenvolvida no NLW Setup, um evento promovido
            pela Rocketseat
          </p>
          <Button
            name="Ver Projeto"
            anchor="https://github.com/CleiltonRocha/habits"
            target="_blank"
          />
        </div>
      </div>
      <div className="group relative overflow-hidden bg-cover bg-no-repeat rounded-2xl">
        <Image
          src={ImgCapsuladoTempo}
          alt="Imagem do projeto Cápsula do Tempo"
          className="transition duration-500 ease-in-out group-hover:scale-110"
        />
        <div className="flex flex-col gap-3 items-start justify-end w-full h-full rounded-2xl py-4 px-4 bg-gradient-to-t from-blackpearl-950 to-transparent absolute -bottom-[100%] transition-all duration-500 invisible group-hover:visible group-hover:bottom-0">
          <div className="flex items-center justify-start gap-4 w-full flex-wrap">
          ...
          <p className="text-left font-normal text-zinc-200 text-[0.875rem]">
            Projeto desenvolvido no NLW Spacetime, um evento promovido pela
            Rocketseat.
          </p>
          <Button
            name="Ver Projeto"
            anchor="https://github.com/CleiltonRocha/capsula-do-tempo"
            target="_blank"
          />
        </div>
      </div>
      <div className="group relative overflow-hidden bg-cover bg-no-repeat rounded-2xl">
        <Image
          src={ImgLoctrazWebsite}
          alt="Imagem do projeto Website Loctraz"
          className="transition duration-500 ease-in-out group-hover:scale-110"
        />
        <div className="flex flex-col gap-3 items-start justify-end w-full h-full rounded-2xl py-4 px-4 bg-gradient-to-t from-blackpearl-950 to-transparent absolute -bottom-[100%] transition-all duration-500 invisible group-hover:visible group-hover:bottom-0">
          <div className="flex items-center justify-start gap-4 w-full flex-wrap">
          ...
          <Button
            name="Ver Projeto"
            anchor="https://dribbble.com/shots/21866602-UI-Design-Loctraz-website"
            target="_blank"
          />
        </div>
      </div>
      <div className="group relative overflow-hidden bg-cover bg-no-repeat rounded-2xl">
        ...
        <div className="flex flex-col gap-3 items-start justify-end w-full h-full rounded-2xl py-4 px-4 bg-gradient-to-t from-blackpearl-950 to-transparent absolute -bottom-[100%] transition-all duration-500 invisible group-hover:visible group-hover:bottom-0">
          ...
          <p className="text-left font-normal text-zinc-200 text-[0.875rem]">
            Solução para o desafio de um sistema de listagem de tarefas com
            React
          </p>
          <Button
            name="Ver Projeto"
            anchor="https://todo-list-web-red.vercel.app"
            target="_blank"
          />
        </div>
      </div>
      <div className="group relative overflow-hidden bg-cover bg-no-repeat rounded-2xl">
        ...
        <div className="flex flex-col gap-3 items-start justify-end w-full h-full rounded-2xl py-4 px-4 bg-gradient-to-t from-blackpearl-950 to-transparent absolute -bottom-[100%] transition-all duration-500 invisible group-hover:visible group-hover:bottom-0">
          ...
          <p className="text-left font-normal text-zinc-200 text-[0.875rem]">
            Uma pequena aplicação em RactJS para fixar os conhecimentos de
            useState. A aplicação permite comentar, apagar e curtir posts.
          </p>
          <Button
            name="Ver Projeto"
            anchor="https://todo-list-web-red.vercel.app"
