...
export function Navbar() {
  return (
    <div className="relative flex w-full flex-row items-center justify-center overflow-hidden">
      <nav className="fixed top-10 z-10 flex flex-row items-center justify-between rounded-full bg-zinc-50/5 p-4 backdrop-blur-lg mobile:max-w-[380px] mobile:gap-1 desktop:max-w-[573px] desktop:gap-4">
        <a
          href="#projects"
